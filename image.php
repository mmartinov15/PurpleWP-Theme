...
<div class="content thin">
	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class( 'single post' ); ?>>
			...
			<div class="post-inner">
				...
				<div class="post-meta-bottom">
					...
					<ul>
						<li><?php _e( 'Uploaded by', 'purpleWP' ); ?> <?php the_author_posts_link(); ?></p>
						...
						$url = $image_array['0']; ?>
						<li><?php _e( 'Resolution:', 'purpleWP' ); ?> <?php echo $image_array['1'] . 'x' . $image_array['2'] . ' px'; ?></li>
					</ul>
		...
		endwhile; 
			...
			<p><?php _e( "We couldn't find any posts that matched your query. Please try again.", "purpleWP" ); ?></p>
