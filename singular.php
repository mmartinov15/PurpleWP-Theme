			...
			<div id="post-<?php the_ID(); ?>" <?php post_class( 'post single' ); ?>>
				...
				elseif ( $post_format == 'gallery' ) : ?>
					...
					<div class="featured-media">	
						...
						<?php purpleWP_flexslider( 'post-image' ); ?>
				...
				<div class="post-inner">
					...
					<?php if ( is_single() ) : ?>
						...
						<div class="post-meta-bottom">
							...
							<?php 
							$args = array(
								'before'           => '<div class="clear"></div><p class="page-links"><span class="title">' . __( 'Pages:','purpleWP' ) . '</span>',
								'after'            => '</p>',
								'link_before'      => '<span>',
								'link_after'       => '</span>',
								'separator'        => '',
							...
							<ul>
								...
								<?php if ( has_category() ) : ?>
									<li class="post-categories"><?php _e( 'In', 'purpleWP' ); ?> <?php the_category( ', ' ); ?></li>
								<?php endif; ?>
								...
								<?php edit_post_link( __( 'Edit post', 'purpleWP' ), '<li>', '</li>' ); ?>
							</ul>
					...
					<div class="post-navigation">
						...
						if ( $prev_post ) : ?>
							...
							<a class="post-nav-prev" href="<?php echo get_permalink( $prev_post->ID ); ?>">
								<p>&larr; <?php _e( 'Previous post', 'purpleWP' ); ?></p>
							</a>
						...
						if ( $next_post ) : ?>
							...
							<a class="post-nav-next" href="<?php echo get_permalink( $next_post->ID ); ?>">					
								<p><?php _e( 'Next post', 'purpleWP' ); ?> &rarr;</p>
							</a>
